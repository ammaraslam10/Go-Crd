...
<div id="page-wrapper"<?php if ($template['page_preloader']) { echo ' class="page-loading"'; } ?>>
    ...
    <div id="page-container"<?php if ($page_classes) { echo ' class="' . $page_classes . '"'; } ?>>
        <?php if ($template['inc_sidebar_alt']) { include __DIR__.'\\' . $template['inc_sidebar_alt'] . '.php'; } ?>
        <?php if ($template['inc_sidebar']) { include __DIR__.'\\' . $template['inc_sidebar'] . '.php'; } ?>

        <!-- Main Container -->
        <div id="main-container">
            <?php if ($template['inc_header']) { include __DIR__.'\\' . $template['inc_header'] . '.php'; } ?>
