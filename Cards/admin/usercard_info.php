<?php include('/../assets/inc/config.php'); $template['header_link'] = 'DIRECT USER CARD INFORMATION'; $type='user';?>
            ...
            <table id="example-datatable" class="table table-striped table-bordered table-vcenter">
                ...
                <tbody>
                    <?php
                        ...
                        <?php
                        global $db; 
                        $query = $db->query("SELECT c.*,u.email as user_email FROM card c inner join user u on c.creator = u.id  where c.is_admin=0 ORDER BY id ASC");
                        $i=1;
                        $items = array();
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <form action="" method="post">
                                <button name="edit_card" value="edit_card" data-toggle="tooltip" title="Edit Card" class="btn btn-effect-ripple btn-xs btn-success"><i class="fa fa-pencil"></i></button>
