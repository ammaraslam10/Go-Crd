					...
					<div class="card">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                $statement = "pw_gateways WHERE type='1'";
                                ...
                                if($query->num_rows>0) {
                                    while($row = $query->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            ?></td>
                                            <td>
                                                <a href="./?a=deposit_methods&b=edit&id=<?php echo $row['id']; ?>" title="Edit"><span class="badge badge-primary"><i class="fa fa-pencil"></i> Edit</span></a> 
                                                <a href="./?a=deposit_methods&b=delete&id=<?php echo $row['id']; ?>" title="Delete"><span class="badge badge-danger"><i class="fa fa-trash"></i> Delete</span></a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
