...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="swiper-container introduction pt-5">
            <div class="swiper-wrapper">
                <div class="swiper-slide overflow-hidden text-center">
                    <div class="row no-gutters">
                        <div class="col align-self-center px-3">
                            <img src="<?php echo $settings['url']; ?>icrypto_assets/img/information-graphic1.png" alt="" class="mx-100 my-5">
                            <div class="row">
                ...
                <div class="swiper-slide overflow-hidden text-center">
                    <div class="row no-gutters">
                        <div class="col align-self-center px-3">
                            <img src="<?php echo $settings['url']; ?>icrypto_assets/img/infomarmation-graphics2.png" alt="" class="mx-100 my-5">
                            <div class="row">
                                <div class="container mb-5">
                ...
                <div class="swiper-slide overflow-hidden text-center">
                    <div class="row no-gutters">
                        <div class="col align-self-center px-3">
                            <img src="<?php echo $settings['url']; ?>icrypto_assets/img/infomarmation-graphics3.png" alt="" class="mx-100 my-5">
                            <div class="row">
                                <div class="container mb-5">
        ...
        <!-- login buttons -->
        <div class="row mx-0 bottom-button-container" id="button_row">
            <div class="col">
                <a href="<?php echo $settings['url']; ?>login" class="btn btn-default btn-lg btn-rounded shadow btn-block">Login</a>
            </div>
            <div class="col">
                <a href="<?php echo $settings['url']; ?>register" class="btn btn-white bg-white btn-lg btn-rounded shadow btn-block">Register</a>
            </div>
        </div>
        <!-- login buttons -->
    </div>
