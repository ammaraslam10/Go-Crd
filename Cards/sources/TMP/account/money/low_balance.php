                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                <div class="user-connected-form-block">
                                    ...
                                    <hr/>
                                    <?php
                                        echo error("You don't have enough funds for this request.<br>Would you like to deposit into your wallet or send money directly from credit card?");
                                        ?>
                                        <br>
                                        <a href="<?php echo $settings['url'].'account/money/send'?>" class="btn btn-default btn-lg btn-rounded shadow btn-block">Send Money From Credit Card</a>
                                        <br>
                                        <a href="<?php echo $settings['url'].'account/money/deposit'?>" class="btn btn-default btn-lg btn-rounded shadow btn-block">Deposit Money</a>
